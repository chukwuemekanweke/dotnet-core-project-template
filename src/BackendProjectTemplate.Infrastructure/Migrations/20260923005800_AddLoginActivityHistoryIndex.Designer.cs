...
namespace BackendProjectTemplate.Infrastructure.Migrations
{
    ...
    [Migration("20260923005800_AddLoginActivityHistoryIndex")]
    partial class AddLoginActivityHistoryIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Authentication.Entities.AuthenticationRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Authentication.Entities.LoginActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "StakeholderId", "OccurredAtUtc", "Id");

                    b.ToTable("LoginActivities", "authentication");
                });

            modelBuilder.Entity("BackendProjectTemplate.Domain.Common.FileUploads.Entities.FileUploadSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("DestinationVisibility")
                        .HasColumnType("integer");

                    b.Property<long>("ExpectedContentLength")
                    ...
                    b.Property<Guid?>("InitiatedByStakeholderId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ValidatedETag")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
                    ...
                    b.ToTable("FileUploadSessions", "infrastructure");
                });

            modelBuilder.Entity("BackendProjectTemplate.Domain.Common.Messaging.MessageInbox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MessageInboxes", "integration");
                });
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Payments.Entities.CountryCurrency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Payments.Entities.Currency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Payments.Entities.PaymentProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Payments.Entities.PaymentProviderConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Payments.Entities.PaymentTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Payments.Entities.PaymentWebhookInbox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Payments.Entities.SubscriptionActivation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Payments.Entities.Wallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Payments.Entities.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Providers.Entities.Provider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Authentication.Entities.IpAddressLocation", b =>
                {
                    b.HasOne("BackendProjectTemplate.Domain.Authentication.Entities.IpAddress", "IpAddress")
                        .WithMany("Locations")
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Authentication.Entities.LoginActivity", b =>
                {
                    ...
                    b.HasOne("BackendProjectTemplate.Domain.Authentication.Entities.IpAddressLocation", "IpAddressLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Payments.Entities.PaymentProviderConfiguration", b =>
                {
                    b.HasOne("BackendProjectTemplate.Domain.Payments.Entities.PaymentProvider", null)
            ...
            modelBuilder.Entity("BackendProjectTemplate.Domain.Stakeholders.Entities.Stakeholder", b =>
                {
                    b.HasOne("BackendProjectTemplate.Domain.Authentication.Entities.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("BackendProjectTemplate.Domain.Stakeholders.Entities.Stakeholder", "AppUserId")
